...
export const CATEGORY_GROUPS = {
  "Vehicles":            ["Car", "Van", "Motorcycle", "Scooter", "Three Wheeler", "Truck / Lorry",
                          "Bus / Coach", "Tuk Tuk", "SUV / Jeep", "Luxury Car", "Pickup Truck", "Electric Vehicle"],
  "Wedding & Events":    ["Wedding Car", "Wedding Decor", "Sound & Lighting", "Event Tent / Marquee",
                          "DJ Equipment", "Stage & Backdrop", "Photo Booth", "Catering Equipment",
                          "Tables & Chairs", "Wedding Photography"],
  "Construction":        ["Heavy Machinery", "Construction Equipment", "Generator", "Power Tools",
                          "Scaffolding", "Concrete Mixer", "Compressor", "Welding Equipment", "Crane"],
  "Property":            ["House / Villa", "Apartment / Room", "Commercial Space", "Warehouse",
                          "Event Venue", "Meeting Room", "Studio Space", "Parking Space"],
  "Electronics & Media": ["Camera & Photography", "Video Equipment", "AV Equipment", "Computer & IT",
                          "Drone", "Projector", "PA System", "Gaming Equipment", "Smart TV / Display"],
  "Marine & Water Sports":["Boat", "Speedboat", "Fishing Boat", "Jet Ski", "Kayak / Canoe",
                          "Paddleboard", "Scuba Equipment"],
  "Sports & Outdoors":   ["Sports Equipment", "Bicycle", "Camping Gear", "Gym Equipment",
                          "Surfboard", "Fishing Equipment", "Trekking Gear", "Cricket Equipment"],
  "Party & Leisure":     ["Party Items", "Bouncy Castle", "Karaoke Machine",
                          "Party Lights", "Bubble Machine", "Fog Machine"],
  "Home & Garden":       ["Furniture", "Garden Equipment", "Pressure Washer",
                          "Cleaning Equipment", "BBQ / Grill", "Outdoor Furniture"],
  "Baby & Kids":         ["Baby Stroller", "Baby Cot", "Car Seat",
                          "Kids Party Items", "Toys & Games", "Kids Bicycle"],
  "Clothing":            ["Formal Wear", "Costume & Theatrical", "Traditional Wear",
                          "Saree & Kandyan", "Accessories & Jewellery"],
  "Medical Equipment":   ["Wheelchair", "Crutches", "Hospital Bed", "Oxygen Equipment", "Medical Equipment"],
  "Other":               ["Other"],
};
...
export const CATEGORY_ICONS = {
  ...
  "Scooter":                "bi-scooter",
  "Three Wheeler":          "bi-taxi-front",
  "Truck / Lorry":          "bi-truck-front-fill",
  "Bus / Coach":            "bi-bus-front",
  "Tuk Tuk":                "bi-taxi-front",
  "SUV / Jeep":             "bi-truck",
  "Luxury Car":             "bi-car-front",
  "Pickup Truck":           "bi-truck-front-fill",
  "Electric Vehicle":       "bi-lightning-charge",
  // Wedding & Events
  ...
  "Stage & Backdrop":       "bi-easel2",
  "Photo Booth":            "bi-camera2",
  "Catering Equipment":     "bi-cup-hot",
  "Tables & Chairs":        "bi-grid-1x2",
  "Wedding Photography":    "bi-camera-fill",
  // Construction
  ...
  "Concrete Mixer":         "bi-gear",
  "Compressor":             "bi-wind",
  "Welding Equipment":      "bi-fire",
  "Crane":                  "bi-building",
  // Property
  "House / Villa":          "bi-house-door",
  "Apartment / Room":       "bi-building",
  "Commercial Space":       "bi-shop",
  "Warehouse":              "bi-building-fill",
  "Event Venue":            "bi-geo-alt-fill",
  "Meeting Room":           "bi-people-fill",
  "Studio Space":           "bi-camera",
  "Parking Space":          "bi-p-square",
  // Electronics & Media
  ...
  "PA System":              "bi-speaker",
  "Gaming Equipment":       "bi-joystick",
  "Smart TV / Display":     "bi-tv",
  // Marine & Water Sports
  "Boat":                   "bi-water",
  "Speedboat":              "bi-water",
  "Fishing Boat":           "bi-water",
  "Jet Ski":                "bi-wind",
  "Kayak / Canoe":          "bi-water",
  "Paddleboard":            "bi-water",
  "Scuba Equipment":        "bi-droplet-fill",
  // Sports & Outdoors
  "Sports Equipment":       "bi-trophy",
  "Bicycle":                "bi-bicycle",
  "Camping Gear":           "bi-tree",
  "Gym Equipment":          "bi-trophy",
  "Surfboard":              "bi-water",
  "Fishing Equipment":      "bi-water",
  "Trekking Gear":          "bi-map",
  "Cricket Equipment":      "bi-trophy",
  // Party & Leisure
  "Party Items":            "bi-gift",
  "Bouncy Castle":          "bi-balloon",
  "Karaoke Machine":        "bi-music-note-beamed",
  "Party Lights":           "bi-lightbulb",
  "Bubble Machine":         "bi-circle",
  "Fog Machine":            "bi-cloud-fog2",
  // Home & Garden
  "Furniture":              "bi-house",
  "Garden Equipment":       "bi-tree",
  "Pressure Washer":        "bi-droplet-fill",
  "Cleaning Equipment":     "bi-brush",
  "BBQ / Grill":            "bi-fire",
  "Outdoor Furniture":      "bi-tree",
  // Baby & Kids
  "Baby Stroller":          "bi-person",
  "Baby Cot":               "bi-person-fill",
  "Car Seat":               "bi-car-front",
  "Kids Party Items":       "bi-balloon",
  "Toys & Games":           "bi-puzzle",
  "Kids Bicycle":           "bi-bicycle",
  // Clothing
  "Formal Wear":            "bi-person-badge",
  "Costume & Theatrical":   "bi-mask",
  "Traditional Wear":       "bi-person-dress",
  "Saree & Kandyan":        "bi-person-dress",
  "Accessories & Jewellery":"bi-gem",
  // Medical Equipment
  "Wheelchair":             "bi-person",
  "Crutches":               "bi-person-walking",
  "Hospital Bed":           "bi-hospital",
  "Oxygen Equipment":       "bi-lungs",
  "Medical Equipment":      "bi-heart-pulse",
  // Other
  "Other":                  "bi-box2",
};
